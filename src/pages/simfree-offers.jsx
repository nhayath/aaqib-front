...
import OffersListSimfree from "@/components/OffersListSimfree";
...
export async function getServerSideProps() {
    ...
    const res = await fetch(
        `${process.env.API_URL}/offers/findOffers?dealType=simfree`
    );
...
async function searchPhones(fq = null, page = 1) {
    let url = `${process.env.API_URL}/offers/findOffers?dealType=simfree&`;
    let args = [];
